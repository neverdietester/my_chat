...
namespace TrainingProgram.Infrastructure.PostgresIdentity.Infrastructure.Repositories.Implementations
{
    public abstract class RepositoryPostgres<T, TPrimaryKey> : IPostgresRepository<T, TPrimaryKey> where T
          : class, IEntity<TPrimaryKey>
    {
        protected readonly Microsoft.EntityFrameworkCore.DbContext Context;
        private readonly DbSet<T> _entitySet;

        protected RepositoryPostgres(Microsoft.EntityFrameworkCore.DbContext context)
        {
            Context = context;
